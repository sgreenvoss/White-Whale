...
Shader "Distant Lands/Stylized Dynamic Coral"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _GradientOffset1;
			float _GradientSmoothness1;
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 vertexValue = ( float4( ( ( _FlutterAmount * appendResult67 ) + ( _MainWaveAmount * float3( 0.01,0.01,0.01 ) * appendResult17 * clampResult42 ) ) , 0.0 ) * input.ase_color ).rgb;
						 ...
						 ) : SV_Target
			{
				...
				float4 lerpResult44 = lerp( _MainColor , _TopColor , saturate( ( ( input.ase_texcoord9.xyz.y - _GradientOffset1 ) * _GradientSmoothness1 ) ));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 lerpResult44 = lerp( _MainColor , _TopColor , saturate( ( ( input.ase_texcoord4.xyz.y - _GradientOffset1 ) * _GradientSmoothness1 ) ));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 lerpResult44 = lerp( _MainColor , _TopColor , saturate( ( ( input.ase_texcoord2.xyz.y - _GradientOffset1 ) * _GradientSmoothness1 ) ));
...
Node;AmplifyShaderEditor.ColorNode;43;-603.7123,-435.2812;Inherit;False;Property;_TopColor;Top Color;0;1;[HDR];Create;True;0;0;0;False;0;False;0.3160377,1,0.695684,1;2,1.215686,1.341177,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;1;-604.168,-613.8814;Inherit;False;Property;_MainColor;Main Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0.3160377,1,0.695684,1;0.8784314,0.3764706,0.542779,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;89;4;94;0
WireConnection;89;8;86;0
ASEEND*/
//CHKSM=691B119CD7AF3DF5539FF7ED5506DD655D53946F