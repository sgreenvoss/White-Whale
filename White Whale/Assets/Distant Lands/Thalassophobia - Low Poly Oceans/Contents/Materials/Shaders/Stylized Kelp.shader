...
Shader "Distant Lands/Stylized Kelp"
{
	Properties
	{
		...
		_GradientSmoothness("Gradient Smoothness", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _FlutterSpeed;
			float _FlutterScale;
			float _MainWaveAmount;
			float _WaveHeightMultiplier;
			float _WaveSpeed;
			float _MainWaveScale;
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float temp_output_59_0 = ( _FlutterSpeed * _TimeParameters.x );
				...
				float4 transform52 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float3 appendResult51 = (float3(transform52.x , ( input.positionOS.xyz.y * _WaveHeightMultiplier ) , transform52.z));
				float temp_output_36_0 = ( _WaveSpeed * _TimeParameters.x );
				...
				float clampResult42 = clamp( input.positionOS.xyz.y , 0.0 , 100000.0 );
				...
				float3 vertexValue = ( ( float4( ( _FlutterAmount * appendResult67 ) , 0.0 ) * input.ase_color ) + float4( ( _MainWaveAmount * float3( 0.01,0.01,0.01 ) * appendResult17 * clampResult42 ) , 0.0 ) ).rgb;
						 ...
						 ) : SV_Target
			{
				...
				float4 lerpResult44 = lerp( _MainColor , _TopColor , saturate( ( ( input.ase_texcoord9.xyz.y - _GradientOffset ) * _GradientSmoothness ) ));
				

				float3 BaseColor = lerpResult44.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( lerpResult44 * _Emmision ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0.0;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 lerpResult44 = lerp( _MainColor , _TopColor , saturate( ( ( input.ase_texcoord4.xyz.y - _GradientOffset ) * _GradientSmoothness ) ));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 lerpResult44 = lerp( _MainColor , _TopColor , saturate( ( ( input.ase_texcoord2.xyz.y - _GradientOffset ) * _GradientSmoothness ) ));
...
/*ASEBEGIN
Version=19602
Node;AmplifyShaderEditor.RangedFloatNode;56;-3033.653,94.50374;Inherit;False;Property;_FlutterSpeed;Flutter Speed;10;0;Create;True;0;0;0;False;0;False;0.5;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-3215.202,451.1026;Inherit;False;Property;_WaveHeightMultiplier;Wave Height Multiplier;7;0;Create;True;0;0;0;False;0;False;1;0.28;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-3055.296,717.2733;Inherit;False;Property;_WaveSpeed;Wave Speed;4;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-2752.999,255.4871;Inherit;False;Property;_FlutterScale;Flutter Scale;11;0;Create;True;0;0;0;False;0;False;1;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-2822.762,980.9027;Inherit;False;Property;_MainWaveScale;Main Wave Scale;5;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-1038.036,-207.0047;Inherit;False;Property;_GradientOffset;Gradient Offset;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;82;-885.8349,-83.15372;Inherit;False;Property;_GradientSmoothness;Gradient Smoothness;6;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;-1766.963,-91.40085;Inherit;False;Property;_FlutterAmount;Flutter Amount;8;0;Create;True;0;0;0;False;0;False;0.3;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-1772.606,535.3686;Inherit;False;Property;_MainWaveAmount;Main Wave Amount;3;0;Create;True;0;0;0;False;0;False;0.3;7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;20;-1465.96,241.0803;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1;-604.168,-613.8814;Inherit;False;Property;_MainColor;Main Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0.3160377,1,0.695684,1;0.0482823,0.2924528,0.08347803,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-1229.23,132.7493;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;75;-337.7106,-255.9082;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;43;-600.1558,-435.2812;Inherit;False;Property;_TopColor;Top Color;0;1;[HDR];Create;True;0;0;0;False;0;False;0.3160377,1,0.695684,1;0.2719638,1,0.2311321,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;85;-174.7759,32.37732;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;92;8;19;0
ASEEND*/
//CHKSM=A10761D53215E8BD7F7698451EE8E3D10499B755